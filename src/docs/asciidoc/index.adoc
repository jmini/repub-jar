...
This is the link:xxx[Eclipse Orbit] project.
...
** The effective jar is calculated (using the https://maven.apache.org/plugins/maven-help-plugin/effective-pom-mojo.html[Apache Maven Help Plugin])
